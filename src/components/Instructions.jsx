export default function Instructions() {
  ...
  const buttonLogoURL = buttonLogo.default; // not used
    ...
    <div className="main-page">
      ...
      <div className="card">
        <div className="card-upper">
          <img
            src={photoURL}
            alt="an organge couch with a pink pillow on it and a net with lemons"
          />
        </div>
        <div className="card-bottom">
          <h2>Start now</h2>
          <p>
            Add shopping items in a form below, store and mark them done to
            archive
          </p>
          {/* Remove unused code for production -1 */}
